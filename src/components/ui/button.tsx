  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cozy: "bg-primary/90 text-primary-foreground hover:bg-primary shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]",
        soft: "bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground",
        warmth: "bg-warmth text-primary-foreground hover:bg-warmth/90 shadow-md hover:shadow-lg",
        gentle: "bg-accent text-accent-foreground hover:bg-accent/80 border border-accent-foreground/10",
        presence: "bg-accent/60 text-accent-foreground border-2 border-accent hover:bg-accent/80 hover:border-accent-foreground/20",
      },
      size: {
